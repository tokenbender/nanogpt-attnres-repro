# FineWeb10B with Block Attention Residuals (48 layers)
# ~20M param GPT-2 style model with higher depth for fuller multi-GPU utilization
#
# Usage:
#   python train.py config/train_fineweb10B_attnres_block_48l.py
#   torchrun --standalone --nproc_per_node=4 train.py config/train_fineweb10B_attnres_block_48l.py

out_dir = "out-fineweb10B-attnres-block-48l"
wandb_run_name = "attnres-block-48l"
